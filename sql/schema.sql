...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`nom_catergory_expenses` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`nom_departments` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`expenses` ;
...
CREATE TABLE IF NOT EXISTS `bamazon`.`expenses` (
  ...
  INDEX `fk_expenses_nom_departments1_idx` (`department_id` ASC) ,
  INDEX `fk_expenses_nom_catergory_expenses1_idx` (`catergory_expenses_id` ASC) ,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`product_departament` ;
...
CREATE TABLE IF NOT EXISTS `bamazon`.`product_departament` (
  ...
  INDEX `fk_product_departament_products1_idx` (`item_id` ASC) ,
  INDEX `fk_product_departament_nom_departments1_idx` (`department_id` ASC) ,
...
-- Table `bamazon`.`sales`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`sales` ;
...
CREATE TABLE IF NOT EXISTS `bamazon`.`sales` (
  ...
  INDEX `fk_sales_user1_idx` (`user_user_id` ASC) )
ENGINE = InnoDB
AUTO_INCREMENT = 11
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`product_sales` ;
...
CREATE TABLE IF NOT EXISTS `bamazon`.`product_sales` (
  ...
  INDEX `fk_product_sales_sales1_idx` (`sales_id` ASC) ,
  INDEX `fk_product_sales_products1_idx` (`item_id` ASC) ,
...
-- Table `bamazon`.`role`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`role` ;
...
-- Table `bamazon`.`users`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`users` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bamazon`.`user_role` ;
...
CREATE TABLE IF NOT EXISTS `bamazon`.`user_role` (
  ...
  INDEX `fk_user_role_user1_idx` (`user_user_id` ASC) ,
...
USE `bamazon`;
DROP procedure IF EXISTS `bamazon`.`add_new_product`;
...
USE `bamazon`;
DROP procedure IF EXISTS `bamazon`.`add_to_inventory`;
...
USE `bamazon`;
DROP procedure IF EXISTS `bamazon`.`buy_product`;
...
USE `bamazon`;
DROP procedure IF EXISTS `bamazon`.`get_user`;
...
USE `bamazon`;
DROP procedure IF EXISTS `bamazon`.`new_department`;

DELIMITER $$
USE `bamazon`$$
CREATE DEFINER=`root`@`localhost` PROCEDURE `new_department`(IN `name` VARCHAR(100))
BEGIN

INSERT INTO nom_departments (department_name)
VALUES (`name`);
...
USE `bamazon`;
DROP procedure IF EXISTS `bamazon`.`products_sale`;
...
DROP VIEW IF EXISTS `bamazon`.`low_inventory` ;
USE `bamazon`;
...
DROP VIEW IF EXISTS `bamazon`.`sale_departament` ;
USE `bamazon`;
...
DROP VIEW IF EXISTS `bamazon`.`total_per_sale` ;
USE `bamazon`;
